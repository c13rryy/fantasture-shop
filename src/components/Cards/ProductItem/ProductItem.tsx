        ...
        <div ref={ref} className="relative">
          <div>
            ...
            <div className="flex flex-col gap-8px w-[132px] pb-22 mt-10">
              <h4 className="text-24 font-semibold leading-7 text-grey_2">
                {title}
              </h4>
          ...
          <div className="absolute top-8px left-8px flex items-center justify-center gap-6px bg-grey_2 w-[65px] py-4 rounded-[8px]">
            <Typo
              tag="h4"
              text={parseFloat(voteAmt.toFixed(1))}
              className="text-white_3"
            />
            <div>
              <Icon icon="star" size={20} color="#d09e23" fill="#d09e23" />
            </div>
          </div>
        </div>
